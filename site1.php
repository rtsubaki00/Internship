...
<body>
    <div class="mx-auto mt-4" style="width: 75%">
       ...
       <h3 class="font-weight-bolder text-center">投稿フォーム</h3>
...
<div class="mx-auto text-center mt-3" style="width: 50%">
...
foreach($message as $mes){
    ...
    <div class="border border-dark rounded text-center mt-3">
                
                <p class="my-2">名前：<?php echo "{$mes["name"]} <br/>"; ?></p>
                <p class="my-2">本文：<?php echo "{$mes["body"]} <br/>"; ?></P>
